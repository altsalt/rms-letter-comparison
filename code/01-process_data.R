...
df_facts$total_mean_account_age <- mean(df$AccountAge, na.rm=TRUE)
df_facts$rr_mean_account_age <- mean(df_rr$AccountAge, na.rm=TRUE)
df_facts$sr_mean_account_age <- mean(df_sr$AccountAge, na.rm=TRUE)

df_facts$total_median_account_age <- median(df$AccountAge, na.rm=TRUE)
df_facts$rr_median_account_age <- median(df_rr$AccountAge, na.rm=TRUE)
df_facts$sr_median_account_age <- median(df_sr$AccountAge, na.rm=TRUE)

df_facts$total_mean_public_repos <- mean(df$PublicRepos, na.rm=TRUE)
df_facts$rr_mean_public_repos <- mean(df_rr$PublicRepos, na.rm=TRUE)
df_facts$sr_mean_public_repos <- mean(df_sr$PublicRepos, na.rm=TRUE)

df_facts$total_median_public_repos <- median(df$PublicRepos, na.rm=TRUE)
df_facts$rr_median_public_repos <- median(df_rr$PublicRepos, na.rm=TRUE)
df_facts$sr_median_public_repos <- median(df_sr$PublicRepos, na.rm=TRUE)

df_facts$total_mean_public_gists <- mean(df$PublicGists, na.rm=TRUE)
df_facts$rr_mean_public_gists <- mean(df_rr$PublicGists, na.rm=TRUE)
df_facts$sr_mean_public_gists <- mean(df_sr$PublicGists, na.rm=TRUE)

df_facts$total_median_public_gists <- median(df$PublicGists, na.rm=TRUE)
df_facts$rr_median_public_gists <- median(df_rr$PublicGists, na.rm=TRUE)
df_facts$sr_median_public_gists <- median(df_sr$PublicGists, na.rm=TRUE)

df_facts$total_mean_followers <- mean(df$Followers, na.rm=TRUE)
df_facts$rr_mean_followers <- mean(df_rr$Followers, na.rm=TRUE)
df_facts$sr_mean_followers <- mean(df_sr$Followers, na.rm=TRUE)

df_facts$total_median_followers <- median(df$Followers, na.rm=TRUE)
df_facts$rr_median_followers <- median(df_rr$Followers, na.rm=TRUE)
df_facts$sr_median_followers <- median(df_sr$Followers, na.rm=TRUE)

df_facts$total_mean_following <- mean(df$Following, na.rm=TRUE)
df_facts$rr_mean_following <- mean(df_rr$Following, na.rm=TRUE)
df_facts$sr_mean_following <- mean(df_sr$Following, na.rm=TRUE)

df_facts$total_median_following <- median(df$Following, na.rm=TRUE)
df_facts$rr_median_following <- median(df_rr$Following, na.rm=TRUE)
df_facts$sr_median_following <- median(df_sr$Following, na.rm=TRUE)
